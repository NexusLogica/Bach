...
Purpose  : Header file for a rational interpolation class.
...
#ifndef __BACH_RATIONAL_INTERP_H__
#define __BACH_RATIONAL_INTERP_H__
...
namespace Bach {
  ...
  class RationalInterp : public Interpolator {
  public:
    RationalInterp(int i = 3);
  ...
  protected:
    ...
    double PerformRationalInterpolation(double,const Eigen::VectorXd&,const Eigen::VectorXd&);
  };
};

#endif // __BACH_RATIONAL_INTERP_H__
